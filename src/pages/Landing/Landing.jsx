    ...
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col w-full mt-10 items-center space-y-10 text-center">
        <div className="flex flex-col items-center space-y-8">
          <h1 className="w-96 lg:w-1/2 text-5xl lg:text-6xl font-semibold">{t("title")}</h1>
        ...
        <Link
          className="bg-indigo-600 bg-opacity-70 lg:hover:bg-opacity-100 text-white py-2 px-4 text-2xl font-semibold rounded-3xl transition-colors duration-500"
          to="/contact"
        >
          {t("get_started")}
        </Link>
        ...
        <div className="mt-10">
          <img
            ...
            src={getOptimizedUrl("MindScan/undraw_medicine")}
            alt="Mental health"
          />
        </div>
