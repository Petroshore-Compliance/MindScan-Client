...
const Footer = () => {
    ...
    return (
        <footer className="bottom-0 left-0 right-0 w-full flex flex-col items-center lg:items-stretch py-4 px-10 space-y-5 bg-white dark:bg-gray-900 border-t-[1px] border-slate-300 dark:border-opacity-20 shadow-2xl">
            <div className="flex flex-col lg:flex-row justify-center lg:justify-between items-start space-y-5 lg:space-y-0">
                ...
                <div className="flex flex-row justify-center space-x-4">
                        <a href="https://www.linkedin.com/company/petroshorecompliance/posts/?feedView=all" target="_blank">
                        ...
                        <a href="https://www.facebook.com/pcbsonline/" target="_blank">
                        ...
                        <a href="https://www.instagram.com/petroshore_compliance/" target="_blank">
