    ...
    return (
        <footer className="bottom-0 left-0 right-0 w-screen flex flex-col items-center lg:items-stretch py-4 px-10 space-y-5 bg-white dark:bg-gray-900 border-t-[1px] border-slate-300 dark:border-opacity-20 shadow-2xl">
            <div className="flex flex-col lg:flex-row justify-center lg:justify-between items-start space-y-5 lg:space-y-0">
                <Link to="/" className="xl:hover:bg-slate-300 xl:hover:bg-opacity-30 py-1 px-3 rounded-3xl transition-colors duration-500">
                    <img
                        key={logo}
                ...
                <div className="flex flex-row justify-center space-x-4">
                        <a href="https://www.linkedin.com/company/petroshorecompliance/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="xl:hover:scale-110 transition-all duration-500">
                        ...
                        <a href="https://www.facebook.com/pcbsonline/" target="_blank" rel="noopener noreferrer" className="xl:hover:scale-110 transition-all duration-500">
                        ...
                        <a href="https://www.instagram.com/petroshore_compliance/" target="_blank" rel="noopener noreferrer" className="xl:hover:scale-110 transition-all duration-500">
